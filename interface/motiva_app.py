...
class MotivaApp(customtkinter.CTk, LeitorCodigo, MovimentacaoService, MatriculaService, FerramentaService):
    ...
    def setup_cadastro_frame(self):
        ...
        self.cadastro_frame_label = customtkinter.CTkLabel(
            self.cadastro_frame, text="Seção de Cadastro",
            font=customtkinter.CTkFont(size=24, weight="bold"),
            text_color=("#1A1A1A", "#FFFFFF")
        )
        self.cadastro_frame_label.grid(row=0, column=0, padx=20, pady=20)

        btn_args = {"fg_color": ("#4169E1", "#FFFFFF"), "text_color": ("#FFFFFF", "#1A1A1A"),
                    "hover_color": ("#365BC9", "#CCCCCC")}

        self.cadastro_button_cadastrar = customtkinter.CTkButton(self.cadastro_frame, text="Cadastrar",
                                                                   command=self.cadastrar_home, **btn_args)
        self.cadastro_button_cadastrar.grid(row=1, column=0, padx=20, pady=10)

        self.cadastro_button_atualizar = customtkinter.CTkButton(self.cadastro_frame, text="Atualizar",
                                                                   command=self.atualizar_home, **btn_args)
        self.cadastro_button_atualizar.grid(row=2, column=0, padx=20, pady=10)

        self.cadastro_button_remover = customtkinter.CTkButton(self.cadastro_frame, text="Remover",
                                                                 command=self.remover_home, **btn_args)
        self.cadastro_button_remover.grid(row=3, column=0, padx=20, pady=10)

        self.cadastro_button_ler = customtkinter.CTkButton(self.cadastro_frame, text="Buscar",
                                                             command=self.buscar_home, **btn_args)
        self.cadastro_button_ler.grid(row=4, column=0, padx=20, pady=10)

        self.cadastro_button_ativar = customtkinter.CTkButton(self.cadastro_frame, text="Ativar",
                                                                command=self.ativar_home, **btn_args)

        self.cadastro_button_ativar.grid(row=5, column=0, padx=20, pady=10)
